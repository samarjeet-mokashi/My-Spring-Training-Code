...
import com.boa.crs.exception.AlreadyGradeAssignedException;
import com.boa.crs.exception.ApprovalPendingException;
import com.boa.crs.exception.CourseAlreadyExistException;
import com.boa.crs.exception.CourseAlreadyRegisterException;
import com.boa.crs.exception.CourseAlreadySelectedException;
import com.boa.crs.exception.CourseIdNotFoundException;
import com.boa.crs.exception.CourseNotAddedException;
import com.boa.crs.exception.CourseNotFoundException;
import com.boa.crs.exception.EmptyStudentListException;
import com.boa.crs.exception.EnrollCoursesNotFoundException;
import com.boa.crs.exception.GradeNotFoundException;
import com.boa.crs.exception.InvalidStudentIdException;
import com.boa.crs.exception.InvalidUserException;
import com.boa.crs.exception.NoCoursesAddedException;
import com.boa.crs.exception.NoPendingApprovalException;
import com.boa.crs.exception.NoUserLoggedInException;
import com.boa.crs.exception.PaymentDeclinedException;
import com.boa.crs.exception.ProfessorIdNotFoundException;
import com.boa.crs.exception.ProfessorNotFoundException;
import com.boa.crs.exception.UnauthorizedAccessException;
import com.boa.crs.exception.WrongCourseSelectionException;
