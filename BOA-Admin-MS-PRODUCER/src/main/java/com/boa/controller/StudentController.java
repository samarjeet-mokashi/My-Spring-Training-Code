...
public class StudentController {
	 ...
	 */
	@RequestMapping(value = "/student/addCourse/{id}/{Course}", method = RequestMethod.POST)
	 ...
	 */
	@RequestMapping(value = "/student/dropCourse/{id}/{Course}", method = RequestMethod.DELETE)
	 ...
	 */
	@RequestMapping(value = "/payment/{studentId}", method = RequestMethod.GET)
